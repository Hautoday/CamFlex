...
public class TextBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 결과 화면으로 이동
                Intent intent = new Intent(TextBookActivity.this, ProductRegisterActivity.class);
    ...
    private void loadProducts() {
        ...
        apiService.getProducts("교재").enqueue(new Callback<List<Product>>() {
            @Override
            public void onResponse(Call<List<Product>> call, Response<List<Product>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (response.body().isEmpty()) {
                        Toast.makeText(TextBookActivity.this, "해당 카테고리의 상품이 없습니다.", Toast.LENGTH_SHORT).show();
                        return;
                    }

                    adapter = new ProductAdapter(TextBookActivity.this, response.body());
                    recyclerView.setAdapter(adapter);
                } else {
                    Toast.makeText(TextBookActivity.this, "데이터 로드 실패 (Code: " + response.code() + ")", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<Product>> call, Throwable t) {
                Toast.makeText(TextBookActivity.this, "서버 연결 실패", Toast.LENGTH_LONG).show();
